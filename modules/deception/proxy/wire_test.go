...
// 改键必须同时改契文档、重新生成夹具 common/api/telemetry/v1/testdata/request_judged_event.json、并同步两侧测试。
func TestRequestJudgedWireContract(t *testing.T) {
	raw, err := os.ReadFile("../../../common/api/telemetry/v1/testdata/request_judged_event.json")
	if err != nil {
